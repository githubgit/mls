...
public final class GoogleAuthHelper {
	 ...
	 */
	private static final String CLIENT_ID = "865725949135-egpa0gmv0jbo08c32qjhmqtiarfuputo.apps.googleusercontent.com";
	/**
	 * Please provide a value for the CLIENT_SECRET constant before proceeding,
	 * set this up at https://code.google.com/apis/console/
	 */
	private static final String CLIENT_SECRET = "jW5LHlUVFqYklF6V9zA_Zf8l";
	/**
	 * Callback URI that google will redirect to after successful authentication
	 */
	private static final String CALLBACK_URI = "http://localhost:8080/oauth.jsp";
