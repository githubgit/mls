package net.tap5.mls.components;

import java.util.LinkedHashMap;
import java.util.Map;

import net.tap5.mls.model.TabGroupModel;
...
/**
 * NB: I would have preferred to use an Environmental instead of a request
 * attribute but I can't
 * http://tapestry.1045711.n5.nabble.com/5-4-alpha-2-Environment
 * -cloaked-during-ajax-component-event-td5719496.html
 */
@Import(stylesheet = "context:css/bootstrap.css")
